...
| 비교 항목 | 범용 AutoML | Vision 전문 툴 | **DeepVi ★** |
|:---|:---:|:---:|:---|
| **코딩 필요성** | ⚠️ 부분 필요 | ✅ 불필요 | ✅ **완전 No-Code** — 라벨링·학습·배포 통합 |
| **라벨링 3종 통합** (Classification · Detection · Segmentation) | ⚠️ 플랫폼마다 상이 | ✅ 라벨링은 강점 | ✅ **단일 환경 내장** |
| **실시간 카메라 추론** | ❌ 별도 개발 필요 | ❌ 미지원 | ✅ **즉시 연동** (학습 완료 후 바로) |
| **학습 속도** | ✅ 빠름 | ⚠️ 보통 | ✅ **수일 내 완결** |
| **자동 재학습 루프** (오탐 → Retrain) | ❌ 미지원 | ⚠️ 분리된 워크플로우 | ✅ **Inference Review** — 자동 누적·재학습·배포 |
| **클라우드 의존성** | ❌ 완전 의존 | ⚠️ 부분 의존 | ✅ **On-Premise 가능** (클라우드 불필요) |
| **데이터 보안** | ❌ 외부 전송 | ❌ 외부 전송 | ✅ **내부 서버 완결 처리** (외부 전송 없음) |
| **도메인 특화 / 커스터마이징** | ⚠️ 제한적 | ⚠️ 제한적 | ✅ **산업별 완전 맞춤** |
| **비전문가 직접 운영** | ⚠️ 클라우드 지식 필요 | ⚠️ 툴마다 상이 | ✅ **현장 담당자 직접 운영** |
